...
export const DetailsPane = ({ children, sx }: { sx: SxProps<Theme>, children?: React.ReactNode[] }) => {
    ...
    return (
        <Box justifyContent="center" alignItems="center" textAlign="center" sx={{ height: '90vh', overflowY: "auto", width: 320, p: 1, borderRadius: 0, bgcolor: (theme) => theme.palette.background.paper, gap: 2, ...sx }}>
