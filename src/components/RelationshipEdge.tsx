...
export function RelationshipEdge({
  ...
  const { edgeColor, fontFamily, textColor } = useConfiguration();
      ...
      <EdgeLabelRenderer>
        <div
          ...
          className="nodrag nopan"
            ...
            border: `2px solid ${edgeColor || '#8b7355'}`,
            borderRadius: 12,
            padding: "8px 14px",
            width: "fit-content",
            whiteSpace: "nowrap",
